...
local Window = Luna:CreateWindow({
	Name = "Godo Hub -- Total Roblox Drama", -- This Is Title Of Your Window
	...
	LoadingTitle = "Total Roblox Drama", -- Header for loading screen
	LoadingSubtitle = "by Godosop", -- Subtitle for loading screen
